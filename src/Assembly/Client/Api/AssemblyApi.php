...
class AssemblyApi
{
   ...
   */
  public function getMisSubjects($per_page = '100', $page = '1')
  {
    list($response) = $this->getMisSubjectsWithHttpInfo($per_page, $page);
    return $response;
  }

  /**
   * Operation getMisSubjectsWithHttpInfo
   *
   * List MIS Subjects
   *
   * @param  int $per_page Number of results to return (optional, default to 100)
   ...
   * @throws \Assembly\Client\ApiException on non-2xx response
   * @throws \InvalidArgumentException
   * @return array of \Assembly\Client\Model\MisSubject[], HTTP status code, HTTP response headers (array of strings)
   */
  public function getMisSubjectsWithHttpInfo($per_page = '100', $page = '1')
  {
    $returnType = '\Assembly\Client\Model\MisSubject[]';
    $request = $this->getMisSubjectsRequest($per_page, $page);
    ...
    try {
      ...
      switch ($e->getCode()) {
        case 200:
          $data = ObjectSerializer::deserialize(
            $e->getResponseBody(),
            '\Assembly\Client\Model\MisSubject[]',
            $e->getResponseHeaders()
          );
          $e->setResponseObject($data);
          break;
   ...
   * @return \GuzzleHttp\Promise\PromiseInterface
   */
  public function getMisSubjectsAsync($per_page = '100', $page = '1')
  {
    return $this->getMisSubjectsAsyncWithHttpInfo($per_page, $page)
      ->then(
        function ($response) {
          return $response[0];
        }
  ...
  /**
   * Operation getMisSubjectsAsyncWithHttpInfo
   *
   * List MIS Subjects
   *
   * @param  int $per_page Number of results to return (optional, default to 100)
   ...
   * @return \GuzzleHttp\Promise\PromiseInterface
   */
  public function getMisSubjectsAsyncWithHttpInfo($per_page = '100', $page = '1')
  {
    $returnType = '\Assembly\Client\Model\MisSubject[]';
    $request = $this->getMisSubjectsRequest($per_page, $page);
  ...
  /**
   * Create request for operation 'getMisSubjects'
   *
   * @param  int $per_page Number of results to return (optional, default to 100)
   * @param  int $page Page number to return (optional, default to 1)
   *
   ...
   * @return \GuzzleHttp\Psr7\Request
   */
  protected function getMisSubjectsRequest($per_page = '100', $page = '1')
  {
    if ($per_page !== null && $per_page > 1500) {
      throw new \InvalidArgumentException('invalid value for "$per_page" when calling AssemblyApi.getMisSubjects, must be smaller than or equal to 1500.');
    }
    if ($per_page !== null && $per_page < 1) {
      throw new \InvalidArgumentException('invalid value for "$per_page" when calling AssemblyApi.getMisSubjects, must be bigger than or equal to 1.');
    }

    if ($page !== null && $page < 1) {
      throw new \InvalidArgumentException('invalid value for "$page" when calling AssemblyApi.getMisSubjects, must be bigger than or equal to 1.');
    }


    $resourcePath = '/mis_subjects';
    $formParams = [];
    $queryParams = [];
    $headerParams = [];
    $httpBody = '';
