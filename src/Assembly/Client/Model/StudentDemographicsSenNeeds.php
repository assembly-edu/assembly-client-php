...
/**
 * StudentDemographicsSenNeeds Class Doc Comment
 *
 * @category Class
 ...
 */
class StudentDemographicsSenNeeds implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'student_demographics_sen_needs';
     ...
     * Sets id
     *
     * @param int $id The id of the sen need
     *
     * @return $this
     */
     ...
     * Sets start_date
     *
     * @param \DateTime $start_date The start date for the need
     *
     * @return $this
     */
