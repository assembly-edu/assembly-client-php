...
/**
 * TimetableGroupMisSubject Class Doc Comment
 *
 * @category Class
 ...
 */
class TimetableGroupMisSubject implements ModelInterface, ArrayAccess
{
  ...
  /**
    ...
    * @var string
    */
  protected static $swaggerModelName = 'TimetableGroupMisSubject';
   ...
   * Sets alt_name
   *
   * @param string $alt_name An alternative name of the subject in the MIS
   *
   * @return $this
   */
   ...
   * Sets alt_code
   *
   * @param string $alt_code An alternative of the subject in the MIS
   *
   * @return $this
   */
