...
/**
 * StaffMemberList Class Doc Comment
 *
 * @category Class
 * @description A page of staff_member objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class StaffMemberList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'staff_member_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\StaffMemberListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\StaffMemberListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\StaffMemberListData[] $data The paged data
     *
     * @return $this
     */
