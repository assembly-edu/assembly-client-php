...
/**
 * StaffMemberQualificationInfoQualifications Class Doc Comment
 *
 * @category Class
 ...
 */
class StaffMemberQualificationInfoQualifications implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'staff_member_qualification_info_qualifications';
     ...
     * Sets id
     *
     * @param int $id Internal stable ID given to all staff qualifications on the Platform
     *
     * @return $this
     */
     ...
     *
     * @param string $first_subject_code A code identifying the main or joint main subject of the qualification
     *
     * @return $this
     */
     ...
     *
     * @param string $first_subject_name The name of the subject
     *
     * @return $this
     */
     ...
     *
     * @param string $second_subject_code A code identifying the main or joint main subject of the qualification
     *
     * @return $this
     */
     ...
     *
     * @param string $second_subject_name The name of the subject
     *
     * @return $this
     */
