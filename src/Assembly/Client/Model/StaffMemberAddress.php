...
/**
 * StaffMemberAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class StaffMemberAddress implements ModelInterface, ArrayAccess
{
  ...
  /**
    ...
    * @var string
    */
  protected static $swaggerModelName = 'StaffMemberAddress';
