...
/**
 * AcademicYearList Class Doc Comment
 *
 * @category Class
 * @description A page of academic_year objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class AcademicYearList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'academic_year_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\AcademicYearListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\AcademicYearListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\AcademicYearListData[] $data The paged data
     *
     * @return $this
     */
