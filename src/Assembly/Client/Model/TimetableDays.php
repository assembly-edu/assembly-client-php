...
/**
 * TimetableDays Class Doc Comment
 *
 * @category Class
 ...
 */
class TimetableDays implements ModelInterface, ArrayAccess
{
  ...
  /**
    ...
    * @var string
    */
  protected static $swaggerModelName = 'TimetableDays';
   ...
   * Gets periods
   *
   * @return \Assembly\Client\Model\TimetablePeriods[]
   */
   ...
   * Sets periods
   *
   * @param \Assembly\Client\Model\TimetablePeriods[] $periods Provides details of the individual periods that make up the day
   *
   * @return $this
   */
