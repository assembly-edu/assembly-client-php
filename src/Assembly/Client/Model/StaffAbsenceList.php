...
/**
 * StaffAbsenceList Class Doc Comment
 *
 * @category Class
 * @description A page of staff_absence objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class StaffAbsenceList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'staff_absence_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\StaffAbsenceListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\StaffAbsenceListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\StaffAbsenceListData[] $data The paged data
     *
     * @return $this
     */
