...
class ContactStudents implements ModelInterface, ArrayAccess
{
  ...
  /**
    ...
    * @var string
    */
  protected static $swaggerModelName = 'ContactStudents';
  ...
  {
    $this->container['object'] = isset($data['object']) ? $data['object'] : 'contact_student';
   ...
   * Sets student_id
   *
   * @param int $student_id The ID of a student this is a contact for
   *
   * @return $this
   */
