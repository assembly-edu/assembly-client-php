...
/**
 * StaffContractSalaries Class Doc Comment
 *
 * @category Class
 ...
 */
class StaffContractSalaries implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'staff_contract_salaries';
     ...
     * Sets hours_per_week
     *
     * @param float $hours_per_week No description
     *
     * @return $this
     */
     ...
     * Sets fte
     *
     * @param float $fte No description
     *
     * @return $this
     */
     ...
     * Sets weeks_per_year
     *
     * @param float $weeks_per_year No description
     *
     * @return $this
     */
     ...
     * Sets pay_range
     *
     * @param string $pay_range No description
     *
     * @return $this
     */
     ...
     *
     * @param string $pay_scale_framework No description
     *
     * @return $this
     */
     ...
     * Sets regional_spine
     *
     * @param string $regional_spine No description
     *
     * @return $this
     */
     ...
     * Sets base_pay
     *
     * @param float $base_pay No description
     *
     * @return $this
     */
     ...
     * Sets actual_pay
     *
     * @param float $actual_pay No description
     *
     * @return $this
     */
     ...
     *
     * @param bool $safeguarded_salary No description
     *
     * @return $this
     */
