...
/**
 * TimetablePeriods Class Doc Comment
 *
 * @category Class
 ...
 */
class TimetablePeriods implements ModelInterface, ArrayAccess
{
  ...
  /**
    ...
    * @var string
    */
  protected static $swaggerModelName = 'TimetablePeriods';
   ...
   * Gets lessons
   *
   * @return \Assembly\Client\Model\TimetableLessons[]
   */
   ...
   * Sets lessons
   *
   * @param \Assembly\Client\Model\TimetableLessons[] $lessons Provides details of the individual lessons that make up the period
   *
   * @return $this
   */
