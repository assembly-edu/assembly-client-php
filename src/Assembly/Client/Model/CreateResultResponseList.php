...
/**
 * CreateResultResponseList Class Doc Comment
 *
 * @category Class
 * @description A page of create_result_response objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class CreateResultResponseList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'create_result_response_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\CreateResultResponseListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\CreateResultResponseListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\CreateResultResponseListData[] $data The paged data
     *
     * @return $this
     */
