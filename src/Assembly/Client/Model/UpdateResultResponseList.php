...
/**
 * UpdateResultResponseList Class Doc Comment
 *
 * @category Class
 * @description A page of update_result_response objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class UpdateResultResponseList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'update_result_response_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\UpdateResultResponseListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\UpdateResultResponseListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\UpdateResultResponseListData[] $data The paged data
     *
     * @return $this
     */
