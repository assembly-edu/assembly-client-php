...
/**
 * ResultList Class Doc Comment
 *
 * @category Class
 * @description A page of result objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class ResultList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'result_list';
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\CreateResultPayloadResults[] $data The paged data
     *
     * @return $this
     */
