...
/**
 * UpdateMultipleResultPayloadList Class Doc Comment
 *
 * @category Class
 * @description A page of update_multiple_result_payload objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class UpdateMultipleResultPayloadList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'update_multiple_result_payload_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\UpdateMultipleResultPayloadListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\UpdateMultipleResultPayloadListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\UpdateMultipleResultPayloadListData[] $data The paged data
     *
     * @return $this
     */
