...
/**
 * SchoolDetailsList Class Doc Comment
 *
 * @category Class
 * @description A page of school_details objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class SchoolDetailsList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'school_details_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\SchoolDetailsListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\SchoolDetailsListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\SchoolDetailsListData[] $data The paged data
     *
     * @return $this
     */
