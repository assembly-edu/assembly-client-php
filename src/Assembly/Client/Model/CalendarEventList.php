...
/**
 * CalendarEventList Class Doc Comment
 *
 * @category Class
 * @description A page of calendar_event objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class CalendarEventList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'calendar_event_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\CalendarEventListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\CalendarEventListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\CalendarEventListData[] $data The paged data
     *
     * @return $this
     */
