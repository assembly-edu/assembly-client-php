...
/**
 * CreateResultPayloadList Class Doc Comment
 *
 * @category Class
 * @description A page of create_result_payload objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class CreateResultPayloadList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'create_result_payload_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\CreateResultPayloadListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\CreateResultPayloadListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\CreateResultPayloadListData[] $data The paged data
     *
     * @return $this
     */
