...
/**
 * UpdateMultipleResultResponseList Class Doc Comment
 *
 * @category Class
 * @description A page of update_multiple_result_response objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class UpdateMultipleResultResponseList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'update_multiple_result_response_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\UpdateMultipleResultResponseListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\UpdateMultipleResultResponseListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\UpdateMultipleResultResponseListData[] $data The paged data
     *
     * @return $this
     */
