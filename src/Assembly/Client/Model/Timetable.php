...
class Timetable implements ModelInterface, ArrayAccess
{
   ...
   * Gets days
   *
   * @return \Assembly\Client\Model\TimetableDays[]
   */
   ...
   * Sets days
   *
   * @param \Assembly\Client\Model\TimetableDays[] $days Provides details of the individual days that make up the timetable
   *
   * @return $this
   */
