...
/**
 * AssessmentPointList Class Doc Comment
 *
 * @category Class
 * @description A page of assessment_point objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class AssessmentPointList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'assessment_point_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\AssessmentPointListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\AssessmentPointListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\AssessmentPointListData[] $data The paged data
     *
     * @return $this
     */
