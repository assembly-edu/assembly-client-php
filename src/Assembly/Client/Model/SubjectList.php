 ...
 *
 * @category Class
 * @description A page of subject objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class SubjectList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'subject_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\SubjectListData[]'
    ];
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\SubjectListData[] $data The paged data
     *
     * @return $this
     */
