...
/**
 * TelephoneNumberInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class TelephoneNumberInfo implements ModelInterface, ArrayAccess
{
  ...
  /**
    ...
    * @var string
    */
  protected static $swaggerModelName = 'TelephoneNumberInfo';
  ...
  {
    $this->container['object'] = isset($data['object']) ? $data['object'] : 'telephone_number';
   ...
   * Sets type
   *
   * @param string $type The location associated with the telephone number
   *
   * @return $this
   */
