...
/**
 * GradesetList Class Doc Comment
 *
 * @category Class
 * @description A page of gradeset objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class GradesetList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'gradeset_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\GradesetListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\GradesetListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\GradesetListData[] $data The paged data
     *
     * @return $this
     */
