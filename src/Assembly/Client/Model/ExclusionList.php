...
/**
 * ExclusionList Class Doc Comment
 *
 * @category Class
 * @description A page of exclusion objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class ExclusionList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'exclusion_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\ExclusionListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\ExclusionListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\ExclusionListData[] $data The paged data
     *
     * @return $this
     */
