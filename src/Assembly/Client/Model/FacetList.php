...
/**
 * FacetList Class Doc Comment
 *
 * @category Class
 * @description A page of facet objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class FacetList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'facet_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\FacetListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\FacetListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\FacetListData[] $data The paged data
     *
     * @return $this
     */
