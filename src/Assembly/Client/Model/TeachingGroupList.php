...
/**
 * TeachingGroupList Class Doc Comment
 *
 * @category Class
 * @description A page of teaching_group objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class TeachingGroupList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'teaching_group_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\TeachingGroupListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\TeachingGroupListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\TeachingGroupListData[] $data The paged data
     *
     * @return $this
     */
