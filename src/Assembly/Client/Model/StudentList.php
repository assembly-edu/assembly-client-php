...
/**
 * StudentList Class Doc Comment
 *
 * @category Class
 * @description A page of student objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class StudentList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'student_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\StudentListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\StudentListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\StudentListData[] $data The paged data
     *
     * @return $this
     */
