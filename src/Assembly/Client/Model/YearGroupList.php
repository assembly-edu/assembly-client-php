...
/**
 * YearGroupList Class Doc Comment
 *
 * @category Class
 * @description A page of year_group objects
 * @package  Assembly\Client
 * @author   Assembly Developer Team
 * @link     https://github.com/assembly-edu/assembly-client-php
 */
class YearGroupList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'year_group_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\YearGroupListData[]'
    ];
     ...
     * Gets data
     *
     * @return \Assembly\Client\Model\YearGroupListData[]
     */
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\YearGroupListData[] $data The paged data
     *
     * @return $this
     */
