...
class ContactList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'contact_list';
    ...
    protected static $swaggerTypes = [
        ...
        'prev_page' => 'int',
        'next_page' => 'int',
        'data' => '\Assembly\Client\Model\ContactListData[]'
    ];
     ...
     * Sets data
     *
     * @param \Assembly\Client\Model\ContactListData[] $data The paged data
     *
     * @return $this
     */
